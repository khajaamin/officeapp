import { ElementRef, Renderer, TemplateRef, ViewContainerRef } from '@angular/core';
...
export declare class NavbarTemplate {
    constructor(viewContainerRef: ViewContainerRef, templateRef: TemplateRef<Object>, viewCtrl: ViewController);
}

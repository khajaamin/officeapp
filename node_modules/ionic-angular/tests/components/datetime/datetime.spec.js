...
function run() {
    describe('DateTime', function () {
        describe('validate', function () {
            it('should restrict January 1-14, 2000 from selection, then allow it, and restrict December 15-31, 2001', function () {
                datetime.max = '2001-12-15';
                datetime.min = '2000-01-15';
                datetime.pickerFormat = 'MM DD YYYY';
                var picker = new ionic_1.Picker();
            ...
            it('should restrict January 2000 from selection, then allow it, and restrict December 2010', function () {
            ...
            it('should only show 31 valid days in the selected 31 day month, then reset for 28 day, then to 30', function () {
        ...
        describe('generate', function () {
            it('should generate with custom locale short month names from input property', function () {
            ...
            it('should generate with custom locale full month names from input property', function () {
            ...
            it('should replace a picker format with both a day name and a numeric day to use only the numeric day', function () {
            ...
            it('should replace a picker format with only a day name to use a numeric day instead', function () {
            ...
            it('should generate MM DD YYYY pickerFormat with min/max', function () {
                datetime.max = '2010-12-31';
                datetime.min = '2000-01-01';
                datetime.pickerFormat = 'MM DD YYYY';
                var picker = new ionic_1.Picker();
            ...
            it('should generate YYYY pickerFormat with min/max', function () {
        ...
        describe('calcMinMax', function () {
            it('should max date with no max input, but has yearValues input', function () {
            ...
            it('should min date with no min input, but has yearValues input', function () {
                datetime.yearValues = '2000,1996,1992';
                datetime.calcMinMax();
            ...
            it('should min date with only YYYY', function () {
                datetime.min = '1994';
                datetime.calcMinMax();
            ...
            it('should max date with only YYYY', function () {
                datetime.max = '1994';
                datetime.calcMinMax();
            ...
            it('should max date from max input string', function () {
            ...
            it('should min date from max input string', function () {
            ...
            it('should default max date when not set', function () {
                datetime.calcMinMax();
            ...
            it('should default min date when not set', function () {
                datetime.calcMinMax();
        ...
        describe('setValue', function () {
            it('should update existing time value with 12-hour PM DateTimeData value', function () {
                var d = '13:47:20.789Z';
                datetime.setValue(d);
                var dateTimeData = {
                    hour: {
            ...
            it('should update existing time value with 12-hour AM DateTimeData value', function () {
                var d = '13:47:20.789Z';
                datetime.setValue(d);
                var dateTimeData = {
                    hour: {
            ...
            it('should update existing time value with new DateTimeData value', function () {
                var d = '13:47:20.789Z';
                datetime.setValue(d);
                expect(datetime.getValue().hour).toEqual(13);
            ...
            it('should update existing DateTimeData value with new DateTimeData value', function () {
            ...
            it('should parse a ISO date string with no existing DateTimeData value', function () {
                var d = '1994-12-15T13:47:20.789Z';
                datetime.setValue(d);
                expect(datetime.getValue().year).toEqual(1994);
                expect(datetime.getValue().month).toEqual(12);
            ...
            it('should not parse a Date object', function () {
                var d = new Date(1994, 11, 15);
                datetime.setValue(d);
                expect(datetime.getValue()).toEqual({});
            });
            it('should not parse a value with bad data', function () {
                var d = 'umm 1994 i think';
                datetime.setValue(d);
                expect(datetime.getValue()).toEqual({});
            });
            it('should not parse a value with blank value', function () {
        ...
        var datetime;
        beforeEach(function () {
            datetime = new ionic_1.DateTime(new ionic_1.Form(), new ionic_1.Config(), null, {});
        });
